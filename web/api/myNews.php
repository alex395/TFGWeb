...
$json=array();
		...
		$consulta="SELECT * FROM web_noticia INNER JOIN noticias_usuarios ON web_noticia.id=noticias_usuarios.noticia_id where noticias_usuarios.usuario_id='${user_id}'";
